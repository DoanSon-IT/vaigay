        ...
        <>
            {!isOpen && (
                <button
                    ...
                    className="fixed bottom-20 right-5 p-3 sm:p-4 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg hover:shadow-blue-200 transition-all hover:scale-105 z-[101]"
